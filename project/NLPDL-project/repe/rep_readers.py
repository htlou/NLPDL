...
class PCARepReader(RepReader):
    ...
    def get_rep_directions(self, model, tokenizer, hidden_states, hidden_layers, **kwargs):
        ...
        for layer in tqdm(hidden_layers, desc="Getting PCA components"):
    ...
    def get_signs(self, hidden_states, train_labels, hidden_layers):
        ...
        for layer in tqdm(hidden_layers, desc="Getting PCA signs"):
            ...
            for component_index in tqdm(range(self.n_components), desc="Getting PCA signs for each component"):
